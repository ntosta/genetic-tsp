...
//and checking to see if each pair of points is on opposite sides of the other segment. This works because
//the segments intersect if and only if ((A and B are on different sides of [CD]) and (C and D are on different sides of [AB])), 
